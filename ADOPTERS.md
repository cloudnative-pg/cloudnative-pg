...
| [Mirakl](https://www.mirakl.com/) | @ThomasBoussekey | 2025-01-30 | CloudNativePG is the default hosting solution for our marketplace instances. Operating 300+ CloudNativePG, 8 TB of data, we managed to get highly customizable HELM charts that mansages connection pooling, logical replication and many other features  |
