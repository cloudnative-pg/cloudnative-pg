...
| [Obmondo](https://obmondo.com) | @Obmondo | 2024-11-25 | Obmondo uses CloudNativePG in our Open Source Kubernetes meta management platform called KubeAid, which we use with all customers - enabling us to share up to 90% of customer work as open source - including ensuring that all open source apps KubeAid users and customers use, uses a CloudNativePG instance - so they have centralized and easy management of all PostgreSQL instances in clusters.
