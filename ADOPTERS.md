...
| [REWE International AG](https://rewe-group.at/de) | @rewemkris | 2024-08-21 |Hello ! 👋 We are the DBMS Team of the RIAG IT and are responsible for managing databases around the world for our stores, warehouses and online shops. We´re leveraging CloudNativePG's Operator by providing PostgreSQL as a Service and creating highly available databases running on Kubernetes in Google Cloud & OnPremise. |
