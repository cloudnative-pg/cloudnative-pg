...
| [Opencell](https://opencellsoft.com/) | @AntoineMicheaOpencell | 2023-02-27 | Opencell is an OpenSource agile monetization platform that use CloudNativePG to run PostgreSQL clusters for it's SaaS. |
