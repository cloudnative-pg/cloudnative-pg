...
func newTLSConfigFromSecret(
	...
	/*
		There's a special situation when the certificate it's generated by the user that this may or
		may not bring the DNSNames field in which case the verification will fail, to avoid this
		we only verify using the CA only and no the full verification, this must change in the future
	*/
