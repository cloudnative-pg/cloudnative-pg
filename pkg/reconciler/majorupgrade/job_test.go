...
var _ = Describe("Major upgrade Job generation", func() {
	...
	It("creates major upgrade jobs", func() {
		majorUpgradeJob := createMajorUpgradeJobDefinition(&cluster, 1, oldImageInfo.Image, nil)
	...
	DescribeTable(
		...
		Entry("major-upgrade jobs are major upgrades", createMajorUpgradeJobDefinition(&cluster, 1, oldImageInfo.Image, nil), true),
	)
})
