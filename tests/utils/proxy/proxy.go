...
func RetrieveMetricsFromInstance(
	...
	body, err := runProxyRequest(ctx, kubeInterface, &pod, tlsEnabled, url.PathMetrics, url.PostgresMetricsPort)
...
func RetrieveMetricsFromPgBouncer(
	...
	body, err := runProxyRequest(ctx, kubeInterface, &pod, false, url.PathMetrics, url.PgBouncerMetricsPort)
	return string(body), err
}
...
func RetrievePgStatusFromInstance(
	...
	body, err := runProxyRequest(ctx, kubeInterface, &pod, tlsEnabled, url.PathPgStatus, url.StatusPort)
	return string(body), err
}
