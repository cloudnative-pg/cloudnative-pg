...
> **NOTE:** if you want to deploy the operator using an image generated by our CI/CD for testing purposes,
> you can find the `operator-manifest.yaml` attached as an artifact to the related `continuous-delivery.yaml`
> workflow. You can download it and move it to `dist/` directory under the repository you've cloned. Then you can use:
>
> ```sh
>   make deploy
> ```
