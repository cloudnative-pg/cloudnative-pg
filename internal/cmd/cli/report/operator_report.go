...
func (or operatorReport) writeToZip(zipper *zip.Writer, format cli.OutputFormat, folder string) error {
...
func operator(ctx context.Context, format cli.OutputFormat,
...
func tryGetOLMReport(ctx context.Context, format cli.OutputFormat) zipFileWriter {
	...
	olmReport, err := getOlmReport(ctx, cli.Namespace)
	if err != nil {
