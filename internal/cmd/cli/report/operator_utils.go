...
func getWebhooks(
	...
	*admissionregistrationv1.ValidatingWebhookConfigurationList,
	...
	if err := cli.Client.List(ctx, &mutatingWebhookConfigList); err != nil {
	...
	if err := cli.Client.List(ctx, &validatingWebhookConfigList); err != nil {
...
func getWebhookService(
	...
	err := cli.Client.Get(ctx, objKey, &webhookService)
