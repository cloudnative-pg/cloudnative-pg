...
func Generate(ctx context.Context, params Params, dryRun bool, format cli.OutputFormat) error {
	...
	err = cli.Print(userSecret, format, os.Stdout)
	if err != nil {
		return err
	}
	...
	err = cli.Client.Create(ctx, userSecret)
	if err != nil {
		return err
	}
