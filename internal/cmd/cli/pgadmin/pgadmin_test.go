...
var _ = Describe("command methods", func() {
	...
	It("should generate the Deployment object", func() {
		...
		Expect(deployment.ObjectMeta.Namespace).To(Equal(cli.Namespace))
	...
	It("should generate the Service object", func() {
		...
		Expect(service.ObjectMeta.Namespace).To(Equal(cli.Namespace))
	...
	It("should generate the ConfigMap object", func() {
		...
		Expect(configMap.ObjectMeta.Namespace).To(Equal(cli.Namespace))
	...
	It("should generate the Secret object", func() {
		...
		Expect(secret.ObjectMeta.Namespace).To(Equal(cli.Namespace))
