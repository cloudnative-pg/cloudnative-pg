...
// +kubebuilder:rbac:groups=postgresql.cnpg.io,resources=syncquorums,verbs=create;get;watch;delete;list
// +kubebuilder:rbac:groups=postgresql.cnpg.io,resources=syncquorums/status,verbs=get;patch;update;watch
