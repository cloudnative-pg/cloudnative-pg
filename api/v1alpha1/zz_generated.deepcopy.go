...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetaSubset) DeepCopyInto(out *MetaSubset) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetaSubset.
func (in *MetaSubset) DeepCopy() *MetaSubset {
	if in == nil {
		return nil
	}
	out := new(MetaSubset)
