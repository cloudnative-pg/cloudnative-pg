...
// +kubebuilder:webhook:webhookVersions={v1},admissionReviewVersions={v1},path=/mutate-postgresql-cnpg-io-v1-scheduledbackup,mutating=true,failurePolicy=fail,groups=postgresqlx.cnpg.io,resources=scheduledbackups,verbs=create;update,versions=v1,name=mscheduledbackup.kb.io,sideEffects=None
...
// +kubebuilder:webhook:webhookVersions={v1},admissionReviewVersions={v1},verbs=create;update,path=/validate-postgresql-cnpg-io-v1-scheduledbackup,mutating=false,failurePolicy=fail,groups=postgresqlx.cnpg.io,resources=scheduledbackups,versions=v1,name=vscheduledbackup.kb.io,sideEffects=None
