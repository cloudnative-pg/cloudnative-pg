...
// +kubebuilder:webhook:webhookVersions={v1},admissionReviewVersions={v1},path=/mutate-postgresql-cnpg-io-v1-backup,mutating=true,failurePolicy=fail,groups=postgresqlx.cnpg.io,resources=backups,verbs=create;update,versions=v1,name=mbackup.kb.io,sideEffects=None
...
// +kubebuilder:webhook:webhookVersions={v1},admissionReviewVersions={v1},verbs=create;update,path=/validate-postgresql-cnpg-io-v1-backup,mutating=false,failurePolicy=fail,groups=postgresqlx.cnpg.io,resources=backups,versions=v1,name=vbackup.kb.io,sideEffects=None
