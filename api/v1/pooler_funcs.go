...
// DefaultPauseDuringSwitchoverTimeout is the default for
// PgBouncerSpec.PauseDuringSwitchoverTimeout. It must match the
// kubebuilder default marker on that field.
const DefaultPauseDuringSwitchoverTimeout = 120 * time.Second

// GetPauseDuringSwitchoverTimeout returns the configured timeout or the default.
func (in *PgBouncerSpec) GetPauseDuringSwitchoverTimeout() time.Duration {
	...
	return DefaultPauseDuringSwitchoverTimeout
}
