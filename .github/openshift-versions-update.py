...
def format_table(versions_data, use_color=True):
    ...
    lines.append(
        "Status colors: "
        + colorize("Full", Colors.CYAN + Colors.BOLD, use_color)
        + " support  "
        + colorize("Maintenance", Colors.GREEN + Colors.BOLD, use_color)
        + "  "
        + colorize("EUS", Colors.YELLOW + Colors.BOLD, use_color)
    )
