...
`currentPrimaryFailingSince` | The timestamp when the current primary was deemed unhealthy                                                                                                                        | [*metav1.Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.26/#time-v1-meta)
