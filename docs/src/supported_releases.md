...
|-----------------|----------------------|-------------------|--------------------------|-------------------------------|---------------------------|
| 1.18.x          | Yes                  | November 10, 2022 | ~ April 13, 2023         | 1.23, 1.24, 1.25              |                           |
...
| Version         | Release Date       | Code Freeze      | End of Life              | Supported Kubernetes Versions |
|-----------------|--------------------|------------------|--------------------------|-------------------------------|
| 1.19.0          | January 19, 2023   | January 12, 2023 | -                        |                               |
