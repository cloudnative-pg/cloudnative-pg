...
- Improved TLS certificate verification by adopting `VerifyConnection`, providing
  stronger guarantees over the established connection including full certificate
  chain and hostname validation.
  ([#10478](https://github.com/cloudnative-pg/cloudnative-pg/pull/10478)) <!-- 1.29 1.28 -->

### Fixes

- Fixed spurious failovers caused by transient failures on the primary's HTTP
  status endpoint.
  ([#10445](https://github.com/cloudnative-pg/cloudnative-pg/pull/10445)) <!-- 1.29 1.28 -->

- Fixed failover not being triggered when the primary node becomes unreachable.
  ([#10448](https://github.com/cloudnative-pg/cloudnative-pg/pull/10448)) <!-- 1.29 1.28 -->

- Fixed the stale primary label not being stripped from the former primary Pod
  during failover, which could cause incorrect routing.
  ([#10409](https://github.com/cloudnative-pg/cloudnative-pg/pull/10409)) <!-- 1.29 1.28 -->

- Fixed snapshot restores failing when leftover `pgsql_tmp*` directories were
  present in the data directory.
  ([#10447](https://github.com/cloudnative-pg/cloudnative-pg/pull/10447)) <!-- 1.29 1.28 -->
...
- Fixed the `cnpg` plugin installer incorrectly matching partial filenames
  during checksum verification.
  ([#10411](https://github.com/cloudnative-pg/cloudnative-pg/pull/10411)) <!-- 1.29 1.28 -->
