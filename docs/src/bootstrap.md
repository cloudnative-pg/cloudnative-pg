...
The following manifest creates a new PostgreSQL 15beta1 cluster,
...
spec:
  instances: 3
  imageName: ghcr.io/cloudnative-pg/postgresql:15beta1
...
the same PostgreSQL version (in our case 15beta1).
...
The manifest defines a new PostgreSQL 15beta1 cluster called `cluster-clone-tls`,
