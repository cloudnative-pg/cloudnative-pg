...
The following manifest creates a new PostgreSQL 13.2 cluster,
...
the same PostgreSQL version (in our case 13.2).
...
The manifest defines a new PostgreSQL 13.2 cluster called `cluster-clone-tls`,
